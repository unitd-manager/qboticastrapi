...
async function main() {
  ...
  try {
    ...
    for (const row of itemRows) {
      ...
      // Also, let's look at what if linked post's post_name too!
      ...
      if (objectId) {
        ...
        if (linkedPost.length > 0 && linkedPost[0].post_type !== 'nav_menu_item') {
          ...
          console.log(`    title:', linkedPost[0].ID, linkedPost[0].post_title, linkedPost[0].post_name, linkedPost[0].guid);
        }
      }
    }
